  ...
  return (
    <div className='h-auto pt-6 flex flex-col justify-start items-start'>
      ...
      <div className='mb-4'>
        ...
        <Skeleton height={20} width={200} className='animate-shimmer' style={{ marginTop: '10px' }} />
        {/* Skeleton for director */}
        <Skeleton height={20} width={150} className='animate-shimmer' style={{ marginTop: '10px' }} />
      </div>
