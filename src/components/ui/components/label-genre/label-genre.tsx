...
const LabelGenre = ({id, nameFR, nameEN, nameJP, onClick, locale}:{id:string, nameFR:string, nameEN:string, nameJP:string, onClick:React.MouseEventHandler<HTMLSpanElement>, locale:string}) => {
  return (
